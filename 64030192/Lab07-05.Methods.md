...
คำตอบ: เลข 5 และ 10 จะบวกกัน


รันโปรแกรมลแวบันทึกผลการทำลอง
![image](https://user-images.githubusercontent.com/115066298/236548574-ffbc6d65-8dda-4ba3-a498-3f970590dff8.png)


ผลที่ได้จากการันโปรแกรม เหมือนกับที่คาดหวังไว้หรือไม่ อธิบาย
```
ผลลัพธ์ ไม่ได้อย่างที่คิด ผลลัพธ์ที่ได้จะเป็นเลข 5 และ 10 แสดงติดกัน
```

คำถาม: ถ้าไม่เหมือนที่คิดไว้ นักศึกษามีวิธีการแก้ไขอย่างไรได้บ้าง 
```
แก้ไขโดยใช้ วงเล็บ คุม (a + b) ก็จะได้ผลบวกของตัวแปร a และ b
```
```cs
namespace ConsoleApp16
{
...
```
![image](https://user-images.githubusercontent.com/115066298/236549036-0a0d17df-8c64-40c5-9b3a-f1ba294e772b.png)
