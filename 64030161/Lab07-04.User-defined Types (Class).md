...
{
   string name;
   ulong account_money;                  //เผื่อเจ้าของบัญชีมีเงินเยอะ
...
|-----|------|
|ความเร็วซีพียู  | GHz |
|ขนาดฮาร์ดดิสก์ | Gb, Tb |
|จำนวนหน่วนความจำ     | Gb, Tb |
|ขนาดหน้าจอ     | นิ้ว (inch)  |
|ยีห้อ     | ข้อความ  |
...
|ID  | ตัวเลข |
|ชื่อไฟล์ | ข้อความ |
|ชนิดไฟล์ (extension)    |  ข้อความ  |
|ที่ตั้ง (path)    | ข้อความ |
...
|-----|------|
|ID  | ตัวเลข  |
|ชนิดของรถโดยสาร | ข้อความ |
|ประจำทางหรือไม่   | true, false  |
|อัตราค่าโดยสาร    |  (ตามระยะทาง (กี่บาทต่อกอโลเมตร)หรือมิเตอร์) |
|ต้นทาง  (ถ้าประจำทาง)    | ข้อความ  |
|ปลายทาง (ถ้าประจำทาง)     | ข้อควม  |
|ปรับอากาศหรือไม่       | true, false  |
|มีอาหารเลี้ยงในระหว่างเดินทางหรือไม่      | true, false  |
