...
คำตอบ: โค้ดที่แสดงผลผลรวมของเลข 5 และ 10 และ PrintSum() เป็นฟังก์ชันที่ทำการคำนวณ
```
...
คำตอบ: จะแสดงผลผิดพลาดเนื่องจากการเชื่อมข้อความแบบนี้จะทำให้ตัวแปร a และ b ถูกแปลงเป็น string แล้วถูกต่อกันเป็น string อีกที
```
```cs
...
namespace ConsoleApp16
{
    internal class Program
    {
        ...
        static void PrintSum()
        {
            int a = 5;
            int b = 10;
            Console.WriteLine("Sum of a and b = {0}", a + b);
        }
    }
}
```
...
```
```cs
ผลลัพธ์จะแสดง Sum of a and b = 15
```
