...
```
![image](https://user-images.githubusercontent.com/115066431/236661519-d28ba667-a58a-4ec9-b3f7-2a0acfa43e5c.png)
...
คำตอบ: น่าจะแสดงผลบวกของ a + b____________________________________


รันโปรแกรมลแวบันทึกผลการทำลอง

![image](https://user-images.githubusercontent.com/115066431/236661709-6ce17dd7-a262-4246-b00b-a12a14742c14.png)


ผลที่ได้จากการันโปรแกรม เหมือนกับที่คาดหวังไว้หรือไม่ อธิบาย

```cs
ไม่เพราะ ผลจากการรันที่ได้เป็นการนำค่า a และ b มาแสดงค่าต่อกัน เป็น 510
```


คำถาม: ถ้าไม่เหมือนที่คิดไว้ นักศึกษามีวิธีการแก้ไขอย่างไรได้บ้าง 

![image](https://user-images.githubusercontent.com/115066431/236661840-12898f83-389f-44e2-bbae-58bb03da3138.png)
...
```cs
เป็นอย่างที่คิดเพราะ มีการนำตัวแปร a และ b มาต่อกันเป็นสตริงและนำไปแสดงผลทันที
แก้โดย การบวกกันนั้นจะต้องใช้วงเล็บเพื่อรวมผลลัพธ์ของ a และ b ก่อนนำไปต่อกับสตริง เพื่อให้ได้ผลลัพธ์ออกมาเท่ากับ 15

```
![image](https://user-images.githubusercontent.com/115066431/236661885-56080b2e-21b1-44a8-a32d-30b0801cfada.png)

### แก้ไข

![image](https://user-images.githubusercontent.com/115066431/236662027-fb1071b5-2e53-4bc9-9e9c-dc9f60aa8589.png)
...
```
![image](https://user-images.githubusercontent.com/115066431/236662069-a7021336-3b6e-40d4-bbd7-94005358ac8b.png)
...
![image](https://user-images.githubusercontent.com/115066431/236662077-04809bbe-bdf0-4cc0-99bd-e5bed3e978e4.png)
...
```
![image](https://user-images.githubusercontent.com/115066431/236662091-28ddb10d-247b-4503-a197-647d42c785f1.png)
...
![image](https://user-images.githubusercontent.com/115066431/236662100-4901e8a2-1ec0-46f4-aa49-94c13ac87193.png)
...
![image](https://user-images.githubusercontent.com/115066431/236662109-743da847-96a8-40b1-b65d-79a6a525b076.png)
...
```
![image](https://user-images.githubusercontent.com/115066431/236662126-09c611e4-38cf-4d0c-a147-4f7e3c15ede7.png)
